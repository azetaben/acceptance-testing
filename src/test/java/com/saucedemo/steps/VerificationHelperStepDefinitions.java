...
/**
 * Step Definitions for VerificationHelper BDD Tests
 * Allows testing VerificationHelper methods using Gherkin syntax
 * Example:
 * Feature: VerificationHelper Color Conversion
 * Scenario: Convert RGB to HEX
 * Given I have RGB values 255, 0, 0
 * When I convert RGB to HEX
 * Then I should get #FF0000
 */
public class VerificationHelperStepDefinitions {
    private static final Logger log = LogManager.getLogger(VerificationHelperStepDefinitions.class);
    ...
    public VerificationHelperStepDefinitions() {
    ...
    // ============================================================
    // DISPLAY STATE VERIFICATION STEPS
    // ============================================================
    ...
    // ============================================================
    // ENABLED STATE VERIFICATION STEPS
    // ============================================================
    ...
    // ============================================================
    // SELECTION STATE VERIFICATION STEPS
    // ============================================================
    ...
    // ============================================================
    // TEXT CONTENT VERIFICATION STEPS
    // ============================================================
    ...
    // ============================================================
    // ATTRIBUTE VERIFICATION STEPS - Using Generic Step Below
    // ============================================================
    ...
    // ============================================================
    // LIST ELEMENT VERIFICATION STEPS
    // ============================================================
    ...
    // ============================================================
    // ELEMENT PRESENCE VERIFICATION STEPS
    // ============================================================
    ...
    // ============================================================
    // CLICKABILITY VERIFICATION STEPS
    // ============================================================
    ...
    // ============================================================
    // GENERIC FRAMEWORK INTEGRATION STEPS (DRY PRINCIPLE)
    // ============================================================

    /**
     * Generic verification step that eliminates duplicates
     * Supports multiple element verification scenarios
     */
    ...
    public void genericVerifyElementState(String elementName, String state) {
        ...
        // Placeholder for actual implementation - maps element names to page elements
        verificationResult = true;
    }

    /**
     * Generic When step for checking element states
     * Maps to isDisplayed, isEnabled, verifyElementIsClickable, etc.
     */
    ...
    /**
     * Generic Then step for verifying results
     * Eliminates multiple Then steps with same logic
     */
    ...
    /**
     * Resolves page name to URL path
     *
     * @param pageName normalized page name (lowercase)
     * @return URL path or null if page not found
     */
    private String resolvePagePath(String pageName) {
        return switch (pageName) {
            ...
            case "checkout-step-two", "checkout step two", "checkout step 2", "checkout overview" -> "/checkout-step-two.html";
    ...
    /**
     * Helper method to navigate to a URL path
     *
     * @param urlPath the relative or absolute URL path
     */
    private void navigateToUrl(String urlPath) {
        try {
            // Get the base URL from configuration using FrameworkConfig
            String baseUrl = com.saucedemo.configReader.FrameworkConfig.getInstance()
                    .getString("url", "https://www.saucedemo.com");
    ...
    /**
     * Helper method to build full URL from base and path
     *
    ...
    private String buildFullUrl(String baseUrl, String path) {
        // Ensure base URL doesn't end with / unless it's the root
    ...
    public void getElementAttribute(String attributeDescription) {
        ...
        // Maps attribute description and gets attribute value
        this.actualText = "";  // Placeholder
    }
    ...
    public void getNamedText(String textDescription) {
        ...
        switch (normalizedTextDescription) {
            case "all product prices" -> actualTextList = pageManager.getPage(InventoryPage.class).getDisplayedPriceTexts();
    ...
    // ============================================================
    // GENERIC ACTION STEPS (ELIMINATE DUPLICATES)
    // ============================================================

...
public class SecuritySteps {
    ...
    public void thePageUrlTitleAndHeadingShouldBeCorrect(String pageName) {
        ...
        if ("login".equals(normalized)) {
            ...
            Assert.assertTrue(actualTitle != null && actualTitle.contains(SauceDemoConstants.APP_TITLE),
                    "Expected page title to contain '" + SauceDemoConstants.APP_TITLE + "' but was '" + actualTitle + "'");
    ...
    public void iAttemptToNavigateDirectlyToTheProductPage() {
        String baseUrl = FrameworkConfig.getInstance().getString("url", SauceDemoConstants.DEFAULT_BASE_URL);

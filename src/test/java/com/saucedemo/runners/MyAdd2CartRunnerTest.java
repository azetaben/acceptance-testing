...
@CucumberOptions(
        monochrome = true,
        features = {RunnerConstants.FEATURE_ROOT + "add-to-cart/"},
        ...
        tags = "@Add2Cart or @regression or @all or @ShippingCart")
public class MyAdd2CartRunnerTest extends AbstractTestNGCucumberTests {

...
@CucumberOptions(
        monochrome = true,
        features = {RunnerConstants.FEATURE_ROOT + "login-logout/login_assertion_helper.feature"},
        ...
        tags = "@login_assertion_helper")
public class LoginAssertionHelperRunner extends AbstractTestNGCucumberTests {

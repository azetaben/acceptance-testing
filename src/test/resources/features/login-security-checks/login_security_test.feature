Feature: Login security checks for Sauce Demo
  ...
  @TC_L&LF_023 @security @login @invalidLogin @regression
  ...
  @TC_L&LF_024 @security @login @invalidLogin @regression
  ...
  @TC_L&LF_025 @security @login @invalidLogin @regression
  ...
  @TC_L&LF_026 @security @login @invalidLogin @regression
  ...
  @TC_L&LF_027 @security @login @regression
  Scenario: 027 - password is hidden by default and visible
    When I enter username "standard_user" and password "secret_sauce"
    Then the password should be hidden

  @TC_L&LF_028 @security @login @invalidLogin @regression
  ...
  @TC_L&LF_029 @security @login @invalidLogin @regression
  ...
  @TC_L&LF_030 @security @login @invalidLogin @regression
  ...
  @TC_L&LF_032 @security @login @invalidLogin @regression
